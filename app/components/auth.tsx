          ...
          <div className={styles["brand-content"]}>
            ...
            <div className={styles["brand-company"]}>
              ...
              <p>
                ...
                <span className={styles["brand-company-value"]}>
                  深圳龙岗区星河双子塔西塔805B
                </span>
              </p>
              <p>
          ...
          <div className={styles["form-container"]}>
            ...
            <form onSubmit={handleSubmit} className={styles["login-form"]}>
              <div className={styles["form-field"]}>
                ...
                <div
                  className={`${styles["input-wrapper"]} ${
                    usernameFocused ? styles["input-wrapper-focused"] : ""
                  } ${
                    usernameValid === true ? styles["input-wrapper-valid"] : ""
                  } ${
                    usernameValid === false
                      ? styles["input-wrapper-invalid"]
                      : ""
                  }`}
                >
                  <input
                  ...
                  {usernameValid === false && (
                    <span className={styles["input-icon"]} aria-hidden="true">
                      ...
                      >
                        <path
                          d="M10 18C14.4183 18 18 14.4183 18 10C18 5.58172 14.4183 2 10 2C5.58172 2 2 5.58172 2 10C2 14.4183 5.58172 18 10 18ZM9 6C9 5.44772 9.44772 5 10 5C10.5523 5 11 5.44772 11 6V10C11 10.5523 10.5523 11 10 11C9.44772 11 9 10.5523 9 10V6ZM9 14C9 13.4477 9.44772 13 10 13H10.01C10.5623 13 11.01 13.4477 11.01 14C11.01 14.5523 10.5623 15 10.01 15H10C9.44772 15 9 14.5523 9 14Z"
                          fill="#EF4444"
                        />
                      </svg>
                    </span>
                ...
                {usernameValid === false && (
                  <p id="username-hint" className={styles["field-hint"]}>
                    请输入用户名
                  </p>
                )}
              </div>
              ...
              <div className={styles["form-field"]}>
                ...
                <div
                  className={`${styles["input-wrapper"]} ${
                    passwordFocused ? styles["input-wrapper-focused"] : ""
                  } ${
                    passwordValid === true ? styles["input-wrapper-valid"] : ""
                  } ${
                    passwordValid === false
                      ? styles["input-wrapper-invalid"]
                      : ""
                ...
                {passwordValid === false && (
                  <p id="password-hint" className={styles["field-hint"]}>
                    请输入密码
                  </p>
                )}
              </div>
